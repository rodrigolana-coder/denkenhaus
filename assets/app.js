...
'Italiano-A1-27': {
  icon: '🗺️',
  titulo: 'Un giorno da turista',
  descricao: 'Organizzare un itinerario, localizzare luoghi e risolvere piccoli problemi durante un viaggio.',
  duracao: '40 min',
  skills: ['Itinerari', 'Luoghi e posizione', 'Situazioni di viaggio'],
  file: 'aulas/it-a1-27.html',
},
'Italiano-A1-28': {
  icon: '🕐',
  titulo: 'Che ore sono?',
  descricao: 'Chiedere e dire l’ora, parlare di appuntamenti e informare gli orari di apertura.',
  duracao: '40 min',
  skills: ['Dire l’ora', 'Appuntamenti', 'Orari'],
  file: 'aulas/it-a1-28.html',
},
'Italiano-A1-29': {
  icon: '🎫',
  titulo: 'Un biglietto per Firenze',
  descricao: 'Comprare un biglietto ferroviario e chiedere informazioni su orari, prezzi e binari.',
  duracao: '40 min',
  skills: ['Viaggiare in treno', 'Biglietti', 'Orari e binari'],
  file: 'aulas/it-a1-29.html',
},
'Italiano-A1-30': {
  icon: '🔄',
  titulo: 'Revisione orale accumulativa',
  descricao: 'Revisione completa delle lezioni precedenti attraverso cento domande di conversazione.',
  duracao: '50 min',
  skills: ['Revisione accumulativa', 'Conversazione', 'Produzione orale'],
  file: 'aulas/it-a1-30.html',
},
'Italiano-A1-31': {
  icon: '🏨',
  titulo: 'La camera d’albergo',
  descricao: 'Descrivere una camera, richiedere servizi e chiedere informazioni alla reception.',
  duracao: '40 min',
  skills: ['In albergo', 'Richieste cortesi', 'C’è e ci sono'],
  file: 'aulas/it-a1-31.html',
},
'Inglês-A1-1': {
    icon: '💬', titulo: 'Presentacións',
    descricao: 'Diálogos reais de apresentação em galego, gramática essencial e vocabulário comparado com o português.',
...
'Inglês-A1-32': {
  icon: '🏠',
  titulo: 'My House',
  descricao: 'Aprender os cômodos da casa, descrever uma casa ou apartamento com have/has, revisar there is/there are e preposições de lugar.',
  duracao: '30 min',
  skills: ['Rooms in the House', 'Have/Has', 'There is/There are'],
  file: 'aulas/en-a1-32.html',
},
'Inglês-A1-33': {
  icon: '🛋️',
  titulo: 'My Home',
  descricao: 'Aprender vocabulário de móveis e eletrodomésticos, apresentar have got/has got, perguntar e responder com Have you got...? e Has... got...?',
  duracao: '30 min',
  skills: ['Furniture & Appliances', 'Have Got/Has Got', 'There is/There are'],
  file: 'aulas/en-a1-33.html',
},
'Inglês-A1-34': {
  icon: '🧹',
  titulo: 'Housework',
  descricao: 'Aprender vocabulário de tarefas domésticas, usar advérbios de frequência e fazer perguntas com How often...? para descrever rotinas de casa.',
  duracao: '30 min',
  skills: ['Housework Vocabulary', 'Adverbs of Frequency', 'How Often...?'],
  file: 'aulas/en-a1-34.html',
},
'Inglês-A1-35': {
  icon: '🍵',
  titulo: 'Curiosity: Why Is Tea So Important in the UK?',
  descricao: 'Texto de leitura sobre a cultura do chá no Reino Unido, revisando Present Simple, advérbios de frequência e vocabulário de comidas e bebidas.',
  duracao: '20 min',
...
'Francês-A2-32': {
  icon: '📅',
  titulo: 'Raconter les suites d\'une rencontre',
  descricao: 'Falar sobre o que aconteceu depois de um encontro e projetos futuros, usando o futur simple e distinguindo dans, en e pendant.',
  duracao: '30 min',
  skills: ['Futur Simple', 'Dans/En/Pendant', 'Radicaux Irréguliers'],
  file: 'aulas/fr-a1-92.html',
},
'Francês-A2-33': {
  icon: '🎓',
  titulo: 'Raconter une expérience universitaire',
  descricao: 'Contar uma experiência universitária e um intercâmbio no exterior, explicando o que tinha acontecido antes de outro evento usando o plus-que-parfait.',
  duracao: '30 min',
  skills: ['Plus-que-parfait', 'Récit au Passé', 'Vie Universitaire'],
  file: 'aulas/fr-a1-93.html',
},
'Francês-A2-34': {
  icon: '💼',
  titulo: 'Parler d\'une expérience professionnelle',
  descricao: 'Contar uma experiência profissional e apresentar competências usando advérbios em -ment, e aprender sua posição no presente, passé composé e plus-que-parfait.',
  duracao: '30 min',
